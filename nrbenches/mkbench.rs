...
#[cfg(feature = "c_nr")]
use node_replication::cnr::{Dispatch, Log, Replica, ThreadToken};
#[cfg(feature = "nr")]
use node_replication::nr::{
    AffinityChange, Dispatch, Log, NodeReplicated, Replica, ReplicaId, ThreadToken,
};
